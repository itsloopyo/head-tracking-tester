...
- **1 to 4 trackers side by side.** Each pane takes a consecutive UDP port from
...
- **Seven procedural scenes:** plaza, city, forest, space, desert, volcano and
...
switched off, because the projection isn't right yet. `WINDOW_MODE_AVAILABLE` at the
