...
![Four trackers driving the same scene, each with its own telemetry panel](https://raw.githubusercontent.com/itsloopyo/head-tracking-tester/main/screenshots/hero-4up.png)
...
![The compare panel ranking four trackers side by side](https://raw.githubusercontent.com/itsloopyo/head-tracking-tester/main/screenshots/compare.png)
...
switching doesn't hitch. There's a screenshot of each in
[`screenshots/`](screenshots), regenerated with `npm run screenshots`.
